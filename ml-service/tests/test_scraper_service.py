...
def test_run_scrape_job_returns_results_for_supported_platforms(monkeypatch):
    monkeypatch.setattr(
        ...
        "PLATFORM_HANDLERS",
        {
            "youtube": lambda _keyword, **kwargs: [_build_item("youtube", "https://youtube.com/watch?v=test1234567")],
            "web": lambda _keyword, **kwargs: [_build_item("web", "https://example.org/video")],
            "telegram": lambda _keyword, **kwargs: [_build_item("telegram", "https://t.me/s/example")],
        },
    )
