			...
			>
				<div className='space-y-4'>
					<p className='text-sm text-(--app-color-text-muted)'>
						This draft was generated by Gemini based on the violation context. Review and copy it to send to the platform's abuse contact.
					</p>
					<textarea
						readOnly
						value={dmcaDraftText}
						rows={12}
						className='w-full resize-none rounded-lg border border-(--app-color-border) bg-(--app-color-surface) p-3 text-sm text-(--app-color-text) focus:border-(--app-color-primary) focus:outline-none'
					/>
